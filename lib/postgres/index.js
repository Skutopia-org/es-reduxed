...
exports.createPostgresEventStoreProvider = void 0;
const pg_listen_1 = __importDefault(require("pg-listen"));
const repository_1 = require("./repository");
const queue_1 = require("../queue");
const createPostgresEventStoreProvider = ({ eventSchema, poolConfig, }) => {
...
exports.createPostgresEventStoreProvider = createPostgresEventStoreProvider;
